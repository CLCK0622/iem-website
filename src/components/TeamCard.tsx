...
const TeamCard = ({
  ...
  return (
    <div
      ...
      } group flex flex-col w-5/6 lg:w-1/4 px-8 p-5 rounded-2xl text-start cursor-default text-white mx-auto lg:mx-5 my-3 border-[0.25px] border-neutral-400/30 bg-neutral-900`}
    >
